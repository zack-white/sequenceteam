...
# TODO Changed to 'esm2_t33_650M_UR50D' from default 36 layer 3B model
def extract_esm(fasta_file, model_location='esm2_t33_650M_UR50D',
    ...
    with torch.no_grad():
        for batch_idx, (labels, strs, toks) in enumerate(data_loader):
            ...
            for i, label in enumerate(labels):
                ...
                #TODO 33 VS 36
                data.append(result["mean_representations"][33])
    data = torch.stack(data).reshape(-1, 1280)
